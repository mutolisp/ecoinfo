...
![ 建立一筆與資料庫的連結](https://i.imgur.com/V8a594Q.png)

![ 建立一筆與資料庫的連結](course/生態資訊學/講義/讓%20Rstudio%20支援資料庫/Rstudio_createdb_connection.png)
...
![ 資料庫連結指令](https://i.imgur.com/oyWIT9X.png)
...
![成功連接資料庫的畫面](https://i.imgur.com/7xRN3cO.png)
